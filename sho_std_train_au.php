...
$(function() {  
  ...
  $("#btn_add_info").on("click", function(){
		...
		$.ajax({
			 url: "exe_work_info_auditor.php",
			 type: "POST",
			 data:  {
							 datework:$("#frm_add_info input[id=dateadd]").val(),
							 auditor_approve:$("#frm_add_info input[id=auditor_approve]").is(":checked"),
				             auditor_comment:$("#frm_add_info textarea[name=auditor_comment]").val(),
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
			...
			events: { // เรียกใช้งาน event จาก json ไฟล์ ที่สร้างด้วย php
              	url: 'events_auditor.php?std_id=<?php echo $_GET["std_id"];?>',
              	error: function() {
              	}
            },
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<form id="frm_add_info" action="exe_work_info_auditor.php" method="POST">  
			<div class="row">
			...
			<div class="row">
			  ...
			  <div class="col-md-7">
				<input type="checkbox" name="auditor_approve" id="auditor_approve" value="1" > รับทราบ</br>
			  </div>
			</div>
			...
			<div class="row">
			  ...
			  <div class="col-md-7">
				<textarea rows="8" id="auditor_comment" name="auditor_comment" class="form-control" > </textarea>
			  </div>
			</div>			
		 </form>	
