...
if (isset ($_REQUEST['staff_approve']) && $_REQUEST['staff_approve'] != "") { $staff_approve = $_REQUEST['staff_approve'] ; } else { $staff_approve = ""; }
if (isset ($_REQUEST['staff_comment']) && $_REQUEST['staff_comment'] != "") { $staff_comment = $_REQUEST['staff_comment'] ; } else { $staff_comment = ""; }
...
$sql = <<<SQL
	...
	WHERE
		std_id = '$std_id' AND office_id = '$office_id' AND info_date = '$datework';				
SQL;
