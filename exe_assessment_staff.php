...
if (isset ($_REQUEST['comment_s']) && $_REQUEST['comment_s'] != "") { $comment_s = $_REQUEST['comment_s'] ; } else { $comment_s = ""; }
if (isset ($_REQUEST['staff_id']) && $_REQUEST['staff_id'] != "") { $staff_id = $_REQUEST['staff_id'] ; } else { $staff_id = ""; }
