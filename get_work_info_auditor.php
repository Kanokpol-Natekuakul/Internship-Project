...
$chk_datework  = "SELECT * FROM `train_info` INNER JOIN `std_info` ON train_info.std_id = std_info.std_id WHERE std_info.`std_id` = '".$std_id."' AND std_info.`auditor_id` = '".$id."' AND `info_date` = '" .$datework."'";
