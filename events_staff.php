...
$sql = "SELECT * FROM `train_info` INNER JOIN `std_info` ON train_info.std_id = std_info.std_id WHERE std_info.`std_id` = '".$std_id."' AND std_info.`office_id` = '".$office_id."' AND std_info.`staff_id` = '".$staff_id."'";								
