...
if (isset ($_REQUEST['work']) && $_REQUEST['work'] != "") { $work = $_REQUEST['work'] ; } else { $work = ""; }
if (isset ($_REQUEST['mode']) && $_REQUEST['mode'] != "") { $mode = $_REQUEST['mode'] ; } else { $mode = ""; }
