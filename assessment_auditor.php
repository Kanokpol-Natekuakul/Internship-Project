...
$(function() {      
  ...
  $("#result").hide();
	...
	$("#frm_assessment_auditor").on('submit',(function(e) {	
		...
		$.ajax ({
			type: "POST", 
			url: "exe_assessment_auditor.php" , 
			cache: false, 
			async: false, 							
			data:  {
							act: "insert",
							std_id: $("#frm_assessment_auditor input[id=std_id]").val(),
							std_prefix: $("#frm_assessment_auditor input[name=std_prefix]:checked").val(),
							std_name:$("#frm_assessment_auditor input[id=std_name]").val(),
							std_sname:$("#frm_assessment_auditor input[id=std_sname]").val(),
							std_group:$("#frm_assessment_auditor input[id=std_group]").val(),
							office_id:$("#frm_assessment_auditor select[id=office_id]").val(),
							first_day:$("#frm_assessment_auditor input[name=first_day]").val(),
							last_day:$("#frm_assessment_auditor input[name=last_day]").val(),
							q1:$("#frm_assessment_auditor input[name=q1]:checked").val(),
							q2:$("#frm_assessment_auditor input[name=q2]:checked").val(),
                            q3:$("#frm_assessment_auditor input[name=q3]:checked").val(),
                            q4:$("#frm_assessment_auditor input[name=q4]:checked").val(),
                            q5:$("#frm_assessment_auditor input[name=q5]:checked").val(),
                            q6:$("#frm_assessment_auditor input[name=q6]:checked").val(),
							q7:$("#frm_assessment_auditor input[name=q7]:checked").val(),
                            q8:$("#frm_assessment_auditor input[name=q8]:checked").val(),
                            q9:$("#frm_assessment_auditor input[name=q9]:checked").val(),
                            q10:$("#frm_assessment_auditor input[name=q10]:checked").val(),
                            q11:$("#frm_assessment_auditor input[name=q11]:checked").val(),
							q12:$("#frm_assessment_auditor input[name=q12]:checked").val(),
                            q13:$("#frm_assessment_auditor input[name=q13]:checked").val(),
                            q14:$("#frm_assessment_auditor input[name=q14]:checked").val(),
                            comment_a:$("#frm_assessment_auditor textarea[name=comment_a]").val(),
							id:$("#frm_assessment_auditor select[name=id]").val(),
			...
			success: function(data) {								
				if (data == 1) {																	
					...
					$("#result").show();
					$("#btn_reg_ok").show();									
					$("#frm_assessment_auditor")[0].reset();	
					$("#register").hide();
				}	
				else {
					$("#result").show();	
...
<div class="container">
  ...
  <div class="row" id="register">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <form id="frm_assessment_auditor" action="" method="POST">
      <div class="row">
    ...
    <h2 class="text-center">เกณฑ์การประเมิน</h2>	
		...
		<div class="row">
		  ...
		  <div class="row">
				<label for="comment_a" class="col-md-4 col-form-label" style="text-align:right">ความคิดเห็น อ.นิเทศ : </label>
			  <div class="col-md-4">
				<textarea rows="8" id="comment_a" name="comment_a" class="form-control" > </textarea>
				</div>
			<div class="col-md-4"> </div>
		  </div><br>
		  ...
		  <div class="row">
					<label for="name" class="col-md-4 col-form-label" style="text-align:right">ลงชื่อ อ.นิเทศ <label style="color:red">*</label> : </label>
          <div class="col-md-4">
			  
						<select class="form-control" id="id" name="id" required>
							<option value="">--ลงชื่อ อ.นิเทศ--</option>			  
								<?php
									require_once('./include/connect.php');
