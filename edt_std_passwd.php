...
$(function() {      
  ...
  $("#result").hide();
	...
	$("#frm_std_passwd").on('submit',(function(e) {	
		e.preventDefault();
		//alert($("#frm_office_info select[id=district_id]").val());
		if ($("#frm_std_passwd input[id=password]").val() != $("#frm_std_passwd input[id=conpassword]").val()) {
		...
		} else 
		{
				$.ajax ({
					type: "POST", 
					url: "exe_std_passwd.php", 
					cache: false, 
					async: false, 							
					data:  {
									curpassword:$("#frm_std_passwd input[id=curpassword]").val(),
									password:$("#frm_std_passwd input[id=password]").val(),
									conpassword:$("#frm_std_passwd input[id=conpassword]").val()										
								},
...
<div class="container">
  ...
  <div class="row" id="register">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <form id="frm_std_passwd" action="" method="POST">
